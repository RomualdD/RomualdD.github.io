...
if(!document.getElementById('happywarsgame')){$(this).append('<div class="row"><img id="happywarsgame" src="assets/img/happywars.gif" height="200px" width="350px"></div>')}});});});});$('.buttonClose').click(function(){$('#hobbies').remove();talkVersion=1;});$('.link').hover(function(){$(this).css("color: red;");})
$('.link').attr({style:"color: white;"});$('.acquirment').attr({style:"color: white; font-family: 'Consola'; margin: 10px;"});$('.buttonTalk').attr({style:"color: black;"});$('#bard').attr({style:"display: block; position: relative; float: right;"});$('#talk').attr({style:"width: 500px; display: block; position: relative; background-color: black; color: yellow; float: right; padding-top: 1.0em; padding-left: 1.0em; padding-right: 1.0em; padding-bottom: 1.0em;"});$('#canvas').attr({style:"position: absolute;"});}},false);}else if(this.x==24&&this.y==5||this.x==22&&this.y==4||this.x==22&&this.y==3||this.x==22&&this.y==2||this.x==24&&this.y==4||this.x==24&&this.y==3||this.x==24&&this.y==2){if(prochaineCase.x==22||prochaineCase.x==25||prochaineCase.x==21){this.x=prochaineCase.x;}
