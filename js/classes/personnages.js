        ...
        if(nameMap == 'troisieme' ) {
            if(this.x == 23 && this.y == 5 || this.x == 23 && this.y == 1) {
                ...
                window.addEventListener('keypress', function(e){
                        if(e.keyCode == 13 && !document.getElementById('wizard')){
                ...
                window.addEventListener('keypress', function(e){
                        if(e.keyCode == 13 && !document.getElementById('wizard')){
                            $('#canvasdiv').append('<img src="assets/img/wizard.png" id="wizard" alt="photo wizard" height="725px" width="425px"/><div id="talk"><p>Bonjour et Bienvenue dans la pr\351sentation de mes comp\351tences</p><p></p></div>');
                            $('#wizard').attr({ style : "display: block; position: relative; float: right;" });
                            $('#talk').attr({ style : "display: block; position: relative; background-color: red; color: yellow; float: right; padding-top: 1.0em; padding-left: 1.0em; padding-right: 1.0em; padding-bottom: 1.0em;" });
                            $('#canvas').attr({ style : "position: absolute;" });
                        };
                    },false);
            }
			...
			/*	<div class="acquirment"><div class="langages">Langages informatiques:</div>\n\
				<div class="col-lg-12><div class="col-lg-1 col-lg-offset-2">HTML/CSS :</div><div class="progress col-lg-offset-5"><div class="progress-bar progress-bar-success progress-bar-striped active html" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">70%</div></div>\n\
				<div class="col-lg-12><div class="col-lg-1 col-lg-offset-2">PHP :</div><div class="progress col-lg-offset-5"><div class="progress-bar progress-bar-success progress-bar-striped active php" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" >60%</div></div>\n\
				<div class="col-lg-12><div class="col-lg-1 col-lg-offset-2">SQL :</div><div class="progress col-lg-offset-5"><div class="progress-bar progress-bar-success progress-bar-striped active sql" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">60%</div></div>\n\
				<div class="col-lg-12><div class="col-lg-1 col-lg-offset-2">C++ :</div><div class="progress col-lg-offset-5"><div class="progress-bar progress-bar-success progress-bar-striped active c" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">50%</div></div>\n\
				<div class="col-lg-12><div class="col-lg-1 col-lg-offset-2">Bootstrap :</div><div class="progress col-lg-offset-5"><div class="progress-bar progress-bar-success progress-bar-striped active bootstrap" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">60%</div></div>\n\
				<div class="col-lg-12><div class="col-lg-1 col-lg-offset-2">JavaScript :</div><div class="progress col-lg-offset-5"><div class="progress-bar progress-bar-success progress-bar-striped active javascript" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100">40%</div></div>\n\
				<div class="col-lg-12><div class="col-lg-1 col-lg-offset-2">jQuery :</div><div class="progress col-lg-offset-5"><div class="progress-bar progress-bar-success progress-bar-striped active javascript" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100">40%</div></div>\n\
				<div class="col-lg-12><div class="col-lg-1 col-lg-offset-2">Canvas :</div><div class="progress col-lg-offset-5"><div class="progress-bar progress-bar-success progress-bar-striped active canvas" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">60%</div></div>\n\
				<div class="col-lg-12><div class="col-lg-1 col-lg-offset-2">Angular/Ionic :</div><div class="progress col-lg-offset-5"><div class="progress-bar progress-bar-success progress-bar-striped active windows" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">25%</div></div></div>\n\
				<div class="col-lg-12><div class="acquirment"><p class="utils">Outils informatiques: </p></div>\n\*/
	return true;
}
